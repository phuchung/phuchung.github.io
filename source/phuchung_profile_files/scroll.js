...
/*Articles*/
	...
	function isScrolledIntoView(elem) {
	   ...
	   var ele = $(elem);
		   if(ele.length){
			   var elemTop = ele.offset().top; //fixed Cannot read property 'top' of undefined
		   }
		...
		var mymessage = $('#description');
			...
			var myelement20 = $('#targetDescription2');
			var mymessage20 = $('#description2');
		    if(isScrolledIntoView(myelement20)) {
		        mymessage20.fadeIn('500');
		    }
		     else {
		        mymessage20.fadeOut('200')
		    }
		...
		var myelement0 = $('#targettruck0');
		var mymessage0 = $('#texttrucks0');
		    if(isScrolledIntoView(myelement0)) {
		        mymessage0.fadeIn('1000,linear');
		    }
		     else {
		        mymessage0.fadeOut('200')
		    }
